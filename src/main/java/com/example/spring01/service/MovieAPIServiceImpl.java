...
public class MovieAPIServiceImpl implements MovieAPIService {
	...
	public String search(String movieNm,String startDt) {
		 String clientId = "x8SjisxW1KilgEyzGF7B"; //애플리케이션 클라이언트 아이디값"
	        String clientSecret = "AMf0cqOIpA"; //애플리케이션 클라이언트 시크릿값"
	        ...
	        String apiURL = "https://openapi.naver.com/v1/search/movie.json?query=" + text+"&yearfrom="+startDt.substring(0, 4);    // json 결과
